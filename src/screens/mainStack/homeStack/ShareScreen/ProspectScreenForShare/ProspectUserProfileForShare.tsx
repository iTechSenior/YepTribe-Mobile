...
const ProspectUserProfileScreenForShare = () => {
  const navigation = useNavigation()
  const shareDataContext = useContext(ShareDataContext)
  const prospectInfo = useNavigationParam('prospectInfoForShare')
  
  shareDataContext.setShareData({
    firstName: prospectInfo.firstName,
    lastName: prospectInfo.lastName,
    deliveryEndpoint: prospectInfo.email,
  })

  const textMsg = shareDataContext.data?.text?.replace('@FIRST_NAME', shareDataContext.data.firstName!)
...
export default ProspectUserProfileScreenForShare
