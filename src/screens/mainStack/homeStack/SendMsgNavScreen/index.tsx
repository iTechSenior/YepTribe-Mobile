...
import SendMsgNavigator from '../../../../navigations/mainNavigator/sendMsgNavigator'
...
const SendMsgNavScreen = () => {
  ...
  const handleCheckBtnClick = () => {
    if (state.firstName === '') {
      ...
      navigation.navigate('ProspectUserProfile', { prospectInfo: state })
    }
  }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.mainContainer}>
        ...
        <SendMsgNavigator navigation={navigation} screenProps={{ setField: (info: Partial<PState>) => setField(info) }} />
      </View>
    </SafeAreaView>
  )
}

SendMsgNavScreen.router = SendMsgNavigator.router
